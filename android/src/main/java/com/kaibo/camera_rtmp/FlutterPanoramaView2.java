...
public class FlutterPanoramaView2 implements PlatformView, MethodChannel.MethodCallHandler {
...
//    private ImageLoaderTask imageLoaderTask;
    ...
    FlutterPanoramaView2(final Context context,
                         BinaryMessenger messenger,
                         int id,
                         Map<String, Object> params) {
        textView=new TextView(context);
        textView.setText("44444444444444444444444");
...
//        imageLoaderTask.execute((String)params.get("uri"), (String)params.get("asset"), (String)params.get("packageName"));
        ...
        // 注册MethodChannel
        methodChannel = new MethodChannel(messenger, "plugins.lqx/camerartmp_" + id);
