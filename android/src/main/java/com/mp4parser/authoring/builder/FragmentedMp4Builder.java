...
public class FragmentedMp4Builder implements Mp4Builder {
     ...
     * <ul>
     * <li>{@link #createMvhd(com.mp4parser.authoring.Movie) mvhd}</li>
     * <li>{@link #createMvex(com.mp4parser.authoring.Movie)  mvex}</li>
     * <li>a {@link #createTrak(com.mp4parser.authoring.Track, com.mp4parser.authoring.Movie)  trak} for every track</li>
     * </ul>
     *
     * @param movie the concerned movie
     ...
     * isofile. Uses {@link #createTfra(com.mp4parser.authoring.Track, com.coremedia.iso.IsoFile)}
     ...
     * by calling {@link #createTrex(com.mp4parser.authoring.Movie, com.mp4parser.authoring.Track)}
